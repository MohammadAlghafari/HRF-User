...
import 'widget/latest_product_view.dart';
import 'widget/products_view.dart';
import '../flashdeal/flash_deal_screen.dart';
import 'widget/top_seller_view.dart';
          ...
          child: CustomScrollView(
            ...
            slivers: [
              ...
              SliverAppBar(
                ...
                title: Provider.of<ThemeProvider>(context).darkTheme
                    ? Image.asset(Images.logo_white, height: 35)
                    : Image.asset(Images.logo_blue, height: 35),
                actions: [
                  IconButton(
                    onPressed: () {
