                          ...
                          builder: (context) => TextButton(
                            onPressed: () async {
                              if (Provider.of<OrderProvider>(context,
                                          ...
                                          .addressIndex ==
                                      null &&
                                  widget.shippingMethodName != 'Pickup') {
        ...
        children: [
          ...
          Expanded(
            child: ListView(
                ...
                children: [
                  // Shipping Details
                  if (widget.shippingMethodName != 'Pickup')
                    Container(
                          ...
                          for (var i = 0;
                            ...
                            Padding(
                              ...
                              child: Row(children: [
                                CachedNetworkImage(
                                  imageUrl:
                                      '${Provider.of<SplashProvider>(context, listen: false).baseUrls.productThumbnailUrl}/${Provider.of<CartProvider>(context, listen: false).cartList[i].thumbnail}',
