...
class TopSellerChatScreen extends StatefulWidget {
  final TopSellerModel topSeller;
  TopSellerChatScreen({@required this.topSeller});

  @override
  State<TopSellerChatScreen> createState() => _TopSellerChatScreenState();
}

class _TopSellerChatScreenState extends State<TopSellerChatScreen> {
    ...
    if (isFirstTime) {
      WidgetsBinding.instance.addPostFrameCallback((_) =>
          Provider.of<ChatProvider>(context, listen: false)
              .initChatList(widget.topSeller.id, context));
      isFirstTime = false;
    }
  }
                    ...
                    ? ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return MessageBubble(
                              chat: chats[index],
                              sellerImage: widget.topSeller.image,
                              onProfileTap: () {
                                Navigator.push(
                                    context,
                                    MaterialPageRoute(
                      ...
                      onTap: () {
                        if (Provider.of<ChatProvider>(context, listen: false)
                          ...
                          MessageBody messageBody = MessageBody(
                              shopId: widget.topSeller.id.toString(),
